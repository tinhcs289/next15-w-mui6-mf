...
- `@shared/states-context`: This package exports a tool for states managenent based on the `Context API` and the [idea of Jack Harringtons](https://www.youtube.com/watch?v=ZKlXqrcBx88&t=4s).
...
- `@shared/zustand-context`: This package exports a mixed of `zustand` and `Context API` for handling multiple instances of store.
