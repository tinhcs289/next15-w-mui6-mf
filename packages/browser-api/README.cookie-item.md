...
## 📦 Import
```typescript
import { CookieItem } "@packages/browser-api/cookie-item";
```
...
import {
  ...
  CookieItemMigration,
} from "@packages/browser-api/cookie-item";
...
import { CookieItem } from "@packages/browser-api/cookie-item";
import { yupMigration } from "@packages/browser-api/cookie-item/adapters/yup";
...
import { z } from "zod";
import { CookieItem } from "@packages/browser-api/cookie-item";
import { zodMigration } from "@packages/browser-api/cookie-item/adapters/zod";
