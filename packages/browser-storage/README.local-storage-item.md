...
## 📦 Import
```typescript
import { LocalStorageItem } "@shared/browser-storage/local-storage-item";
```
...
} from "@shared/browser-storage/local-storage-item";
...
import { LocalStorageItem } from "@shared/browser-storage/local-storage-item";
import { yupMigration } from "@shared/browser-storage/local-storage-item/adapters/yup";
...
import { z } from "zod";
import { LocalStorageItem } from "@shared/browser-storage/local-storage-item";
import { zodMigration } from "@shared/browser-storage/local-storage-item/adapters/zod";
