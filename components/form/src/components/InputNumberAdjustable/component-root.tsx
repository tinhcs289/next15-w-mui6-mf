...
import type { InputNumberAdjustableProps, InputNumberProps, RHFNumberAdjustableProps } from "./types";
    ...
    return (
      ...
      >
        <Grid container width="100%" alignItems="center">
          ...
          <Grid component="div" item xs={10} container px={1} {...inputGridProps}>
            <InputNumber
              fullWidth
              // @ts-ignore
              size="small"
